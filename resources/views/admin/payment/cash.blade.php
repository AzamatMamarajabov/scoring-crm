                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('cashes.store') }}" method="POST" class="form">
                                                        @csrf
                                                        <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    @if (Auth::user()->store_id == $cash->store_id )
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-between">
                                            ...
                                            <a class="btn btn-sm btn-primary" href="{{ route('payment.show', ['payment' => $cash->id]) }}">
                                                <i data-feather="eye" ></i>
                                            </a>
                                            <form action="{{ route('cashes.destroy', ['cash' => $cash->id]) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
                                                <label class="btn btn-sm btn-danger" for="delete{{$cash->id}}">
                                                    <button type="submit" onclick="return confirm('Delete?')"
                                                        id="delete{{$cash->id}}" class="d-none"></button>
